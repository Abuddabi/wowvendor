(()=>{
    ...
    var t, n, o = {
        142: (t,n,o)=>{
            ...
            n.Character = function t() {
                ...
                this.run = function() {
                    !1 === n.isRunning && (n.donut.classList.add("running"),
                    n.isRunning = setInterval((function() {
                        ...
                        if (n.isWin || o)
                            ...
                            ), 10)) : (n.characterAnnotation.style.left = r + 2 + "px",
                ...
                ,
                this.stop = function() {
                    !1 !== n.isRunning && (clearInterval(n.isRunning),
                    n.isRunning = !1,
                ...
                this.jump = function() {
                    if (!1 === n.isJumping) {
                        ...
                        n.isJumping = setInterval((function() {
                            ...
                            i <= t && t <= i + o && !e ? (t = t + 15 >= i + o ? r + 2 : r + 3,
                            n.donut.style.bottom = t + "px",
                            n.characterAnnotation.style.bottom = t + 160 + "px",
                            r + 2 >= i + o && (e = !0)) : i < t && e ? (t = t - 30 >= i ? r - 4 : r - 3,
                            n.characterAnnotation.style.bottom = t + 160 + "px",
                            n.donut.style.bottom = t + "px") : (clearInterval(n.isJumping),
                            n.isJumping = !1,
    ...
    function e(t) {
        ...
        return o[t](n, n.exports, e),
        n.exports
    }
    t = e(98),
    n = e(142),
    document.addEventListener("DOMContentLoaded", (function() {
        window.character = new n.Character,
        window.terrain = new t.Terrain,
        document.addEventListener("keyup", (function(t) {
            "Space" === t.code && window.character.jump(),
            "KeyS" === t.code && window.character.stop(),
            "KeyD" === t.code && window.character.run()
        }
        ))
    }
    ))
